---
title: "MRCAUSE_workflow_clumped_oilyfish_GCST90239664_TG_Graham"
author: "KJS"
date: "2024-09-13"
...
# Load exposure data
X1 <- read.table(gzfile("../../../common/published_gwas/diet/cole_naturecomm_2020/BOLTlmm_UKB_genoQCEURN455146_v3_diet_oilyfish_overallfreq.1329.average_QT_BgenSnps_mac20_maf0.005_info0.6.gz"), header = TRUE)
head(X1)

# Load outcome data
X2 <- readRDS("interim_data/outcome/formatted_GCST90239664_TG_Graham_GRCh37.rds")
head(X2)
str(X2)
```
...
saveRDS(X, paste0("interim_data/MRCAUSE/", exposure, "_", outcome, "_nonLDpruned.rds"))
...
# Save for future
save(list=c("params"), file = paste0("interim_data/MRCAUSE/", exposure, "_", outcome, "_nonLDpruned_params.Rdata"))
# Load if needed
load(file = paste0("interim_data/MRCAUSE/", exposure, "_", outcome, "_nonLDpruned_params.Rdata"))
```
