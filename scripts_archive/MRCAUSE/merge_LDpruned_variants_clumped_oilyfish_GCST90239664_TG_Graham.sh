...
apptainer exec --bind /projects/$USER,/scratch/alpine/$USER --overlay /projects/$USER/.rstudioserver/rstudio-server-4.2.2_overlay.img:ro /curc/sw/containers/open_ondemand/rstudio-server-4.2.2.sif Rscript scripts/merge_LDpruned_variants_clumped_oilyfish_GCST90239664_TG_Graham.R