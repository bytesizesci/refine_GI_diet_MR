---
title: "MRCAUSE_workflow_clumped_alcohol_GCST90013405_ALT_Pazoki"
author: "KJS"
date: "2024-09-16"
...
# Load outcome data
X2 <- readRDS("/pl/active/colelab/users/kjames/enviroMR/interim_data/outcome/formatted_GCST90013405_ALT_Pazoki.rds")
head(X2)
str(X2)
```
...
X <- cause::gwas_merge(X1, X2, snp_name_cols = c("variant_id", "variant"), #SNP 
...
save(list=c("Xp"), file = paste0("interim_data/MRCAUSE/", exposure, "_", outcome, "_LDpruned_variants.Rdata"))
```
