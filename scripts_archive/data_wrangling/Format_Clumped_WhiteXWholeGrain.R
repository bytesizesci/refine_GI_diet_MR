# Goal: Format JBC diet data - white vs whole + brown bread (bin 4)
# Author: KJS
...
# Read data
df <- read.csv("/pl/active/colelab/users/kjames/enviroMR/interim_data/exposure/whiteXwholegrain_clumped_noLD_nobiallelic.csv", row.names = 1)
...
# Save
write.csv(df3, "/pl/active/colelab/users/kjames/enviroMR/interim_data/exposure/formatted_whiteXwholegrain_clumped_noLD_nobiallelic.csv")
saveRDS(df3, "/pl/active/colelab/users/kjames/enviroMR/interim_data/exposure/formatted_whiteXwholegrain_clumped_noLD_nobiallelic.rds")
