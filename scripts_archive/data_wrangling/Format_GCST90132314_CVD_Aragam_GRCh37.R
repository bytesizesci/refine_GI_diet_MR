# Goal: GCST90132314_CVD_Aragam data GRCh37
# Author: KJS
...
#file_path <- "/pl/active/colelab/users/kjames/enviroMR/inputs/GCST90132314_CVD_Aragam/GCST90132314_buildGRCh37.tsv"
file_path_unzipped <- "/pl/active/colelab/users/kjames/enviroMR/inputs/GCST90132314_CVD_Aragam/GCST90132314_buildGRCh37.tsv"
...
df2 = df %>% 
  rename(#"SNP" = "rsid",
         ...
         "cases.outcome" = "cases", # from here down, specific to binary traits
         "effective_cases.outcome" = "effective_cases",
         "odds_ratio.outcome" = "odds_ratio"
  )
...
colnames(df2)
df2 <- df2 %>% select(-markername, -freqse, -minfreq, -maxfreq, -direction, -hetisq, -hetchisq, -hetdf, -hetpval, -meta_analysis)
...
# Save
write.csv(df3, "interim_data/outcome/formatted_GCST90132314_CVD_Aragam_GRCh37.csv")
saveRDS(df3, "interim_data/outcome/formatted_GCST90132314_CVD_Aragam_GRCh37.rds")
