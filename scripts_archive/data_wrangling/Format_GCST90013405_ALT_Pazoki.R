# Goal: GCST90013405_ALT_Pazoki data
# Author: KJS
...
file_path <- "/pl/active/colelab/users/kjames/enviroMR/inputs/GCST90013405_ALT_Pazoki/33972514-GCST90013405-EFO_0004735-Build37.f.tsv.gz"
file_path_unzipped <- "/pl/active/colelab/users/kjames/enviroMR/inputs/GCST90013405_ALT_Pazoki/33972514-GCST90013405-EFO_0004735-Build37.f.tsv"
...
# Save
write.csv(df3, "interim_data/outcome/formatted_GCST90013405_ALT_Pazoki.csv")
saveRDS(df3, "interim_data/outcome/formatted_GCST90013405_ALT_Pazoki.rds")