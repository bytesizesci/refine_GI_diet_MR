...
for (i in seq_along(mrobj)){
  ...
  prettyplot <- ggplot(mrdat, aes(x = beta.exposure, y = beta.outcome)) +
    ...
    scale_color_manual(values = c(
      "Steiger-Kept, Ttest-Kept, PVE-Kept" = "#d73027", #"#440154FF",
      "Steiger-Kept, Ttest-Kept, PVE-Filtered" = "#fc8d59", #"#26828EFF",
      "Steiger-Kept, Ttest-Filtered, PVE-Kept" = "#fee090", #"#6DCD59FF",
      "Steiger-Kept, Ttest-Filtered, PVE-Filtered" = "#ffffbf", #"#3E4A89FF",
      "Steiger-Filtered, Ttest-Kept, PVE-Filtered" = "#e0f3f8", #"#35B779FF",
      "Steiger-Filtered, Ttest-Kept, PVE-Kept" = "#91bfdb", #"#B4DE2CFF",
      "Steiger-Filtered, Ttest-Filtered, PVE-Kept" = "#4575b4" #"#FDE725FF"
      #"Steiger-Filtered, Ttest-Filtered, PVE-Filtered"= "#FDE725FF" #this group (all false- won't occur because it would get removed!)
    )) +
  ...
  # Save
  ggsave(paste0(plots_dir,"/MR_",EXP_pheno, "_", OUT_pheno,"_scatterplot_allmethods_inclusion_exclusion.png"),
         plot = prettyplot,
         device = NULL,
         path = NULL,
         scale = 1,
