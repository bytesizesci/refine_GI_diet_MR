...
file_list="$in_dir/whiteXwholegrain_GCST90239658_LDL_Graham_descendingPVE_filenames.txt" # Files, one per line

# Step 2: Define output directory and reference directory
output_dir="/pl/active/colelab/users/kjames/refinedMR/interim_data/ldsc/results"  # Directory to save results
