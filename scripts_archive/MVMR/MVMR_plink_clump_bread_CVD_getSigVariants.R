...
tmp <- mvmr_dat %>% select(variant.x, phewas_alt, effect_allele.exposure.whiteXwholegrain, beta.exposure.whiteXwholegrain, effect_allele.outcome.CVD, beta.outcome.CVD)
...
tmp1 <- mvmr_dat_harm %>% select(variant.x, phewas_alt, effect_allele.exposure.whiteXwholegrain, beta.exposure.whiteXwholegrain, effect_allele.outcome.CVD, beta.outcome.CVD)
...
tmp2 <- mvmr_dat_harm2 %>% select(variant.x, phewas_alt, effect_allele.exposure.whiteXwholegrain, beta.exposure.whiteXwholegrain, effect_allele.outcome.CVD, beta.outcome.CVD)
