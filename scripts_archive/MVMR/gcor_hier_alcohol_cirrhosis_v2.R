...
res_dir <- "/pl/active/colelab/users/kjames/refinedMR/interim_data/MVMR/alcohol_cirrhosis/plots"
...
# How many clusters?
png(paste0(res_dir,"/",EXP_pheno,"_", OUT_pheno, "_hc_height_defineclusters.png"),
    width = 5000,
    height = 5000,
    res = 300)
...
# Silhouette method
png(paste0(res_dir,"/",EXP_pheno,"_", OUT_pheno, "_hc_silhouette_defineclusters.png"),
    width = 5000,
    height = 5000,
    res = 300)
