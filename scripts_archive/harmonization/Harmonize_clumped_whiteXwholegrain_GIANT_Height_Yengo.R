...
dim(gi_needproxy) #25, brutal - SHARE!
...
save(list= c("proxy_res", "noLD_snps_res", "missing_snps_res", "no_ex_out_snps_res"),
     file = "interim_data/merged_GI/proxydata_exp_out_proxies_whiteXwholegrain_GCST006901_Height_Yengo_2018.Rdata") 
...
saveRDS(#gi_harmon,
  gi3,
  "interim_data/merged_GI/mrdat_exp_out_proxies_whiteXwholegrain_GCST006901_Height_Yengo_2018.rds")
write.csv(#gi_harmon,
  gi3, 
  "interim_data/merged_GI/mrdat_exp_out_proxies_whiteXwholegrain_GCST006901_Height_Yengo_2018.csv")
