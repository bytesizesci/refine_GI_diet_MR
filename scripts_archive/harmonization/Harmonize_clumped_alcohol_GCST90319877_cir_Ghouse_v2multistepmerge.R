# Goal: Harmonize of exposure and outcome data - full exposure
# Exposure: alcohol
...
# Save
saveRDS(gi3, "interim_data/merged_GI/mrdat_exp_out_proxies_alcohol_GCST90319877_cir_Ghouse.rds")
write.csv(gi3, "interim_data/merged_GI/mrdat_exp_out_proxies_alcohol_GCST90319877_cir_Ghouse.csv")
