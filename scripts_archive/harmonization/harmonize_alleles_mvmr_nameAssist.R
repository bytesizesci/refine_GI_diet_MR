...
rename_and_execute <- function(data, func) {
  # Rename columns a, b, c, d to e, f, g, h
  original_names <- c("effect_allele.exposure.x", "other_allele.exposure.x", "effect_allele.exposure.y", "other_allele.exposure.y", "beta.exposure.x","oaf.exposure.x","eaf.exposure.x", "chr.exposure.x", "pos.exposure.x" )
