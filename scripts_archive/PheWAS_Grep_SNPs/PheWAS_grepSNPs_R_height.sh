...
# To run, 
# sbatch scripts/PheWAS_Grep_SNPs/PheWAS_grepSNPs_R_height.sh
...
# run Rscript
Rscript /pl/active/colelab/users/kjames/refinedMR/scripts/PheWAS_Grep_SNPs/PheWAS_grepSNPs_R_height.R $SLURM_ARRAY_TASK_ID 