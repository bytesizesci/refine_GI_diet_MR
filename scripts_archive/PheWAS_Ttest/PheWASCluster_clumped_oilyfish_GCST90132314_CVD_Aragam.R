...
df <- readRDS(paste0("interim_data/merged_GI/standardized_shared/std_mrdat_", exposure, "_", outcome ,"_GRCh37.rds")) 
...
# Save
saveRDS(mrobj, "interim_data/merged_GI/standardized_shared/std_mrobject_steiger_PheWASClust_240925.rds")
