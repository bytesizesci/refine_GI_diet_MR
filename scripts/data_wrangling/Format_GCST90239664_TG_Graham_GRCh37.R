# Goal: GCST90239664_TG_Graham data GRCh37
# Author: KJS
...
# Build 37
#file_path <- "/pl/active/colelab/users/kjames/enviroMR/inputs/GCST90239664_TG_Graham/GCST90239664_buildGRCh37.tsv"
file_path_unzipped <- "/pl/active/colelab/users/kjames/enviroMR/inputs/GCST90239664_TG_Graham/GCST90239664_buildGRCh37.tsv"
...
#df2$samplesize.outcome <- 340162 + 145515
...
# Save
write.csv(df3, "interim_data/outcome/formatted_GCST90239664_TG_Graham_GRCh37.csv")
saveRDS(df3, "interim_data/outcome/formatted_GCST90239664_TG_Graham_GRCh37.rds")
