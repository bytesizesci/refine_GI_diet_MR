# Goal: Format JBC full diet data - bread type, white vs whole/brown
# Author: KJS
...
ex_full <- read.table("/pl/active/colelab/common/published_gwas/diet/cole_naturecomm_2020/BOLTlmm_UKB_genoQCEURN455146_v3_diet_bread_typeused.1448.average_bin4_BgenSnps_mac20_maf0.005_info0.6.gz", header = TRUE)
head(ex_full)
...
df2$samplesize.exposure <- 416312
...
# Save
write.csv(df3, "/pl/active/colelab/users/kjames/refinedMR/interim_data/exposure/formatted_whiteXwholegrain_clumped_full_sumstats.csv")
saveRDS(df3, "/pl/active/colelab/users/kjames/refinedMR/interim_data/exposure/formatted_whiteXwholegrain_clumped_full_sumstats.rds")
