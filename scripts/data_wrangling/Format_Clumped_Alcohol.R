# Goal: Format JBC diet data - alcohol
# Author: KJS
...
# Read data
df <- read.csv("/pl/active/colelab/users/kjames/enviroMR/interim_data/exposure/alcohol_clumped_noLD_nobiallelic.csv", row.names = 1)
...
# Save
write.csv(df3, "/pl/active/colelab/users/kjames/enviroMR/interim_data/exposure/formatted_alcohol_clumped_noLD_nobiallelic.csv")
saveRDS(df3, "/pl/active/colelab/users/kjames/enviroMR/interim_data/exposure/formatted_alcohol_clumped_noLD_nobiallelic.rds")
