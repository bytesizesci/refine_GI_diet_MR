...
# ./MVMR_plink_clump_alcohol_ALT_clumpedGI.sh
...
for chr in {1..22}; do
  plink \
    ...
    --clump-r2 0.01 \
    --clump-kb 10000 \
    --out /pl/active/colelab/users/kjames/refinedMR/interim_data/MVMR/${diet_outcome}/${GI_clumped}/GI_clumped_results_${trait}_chr${chr}.tsv
done
