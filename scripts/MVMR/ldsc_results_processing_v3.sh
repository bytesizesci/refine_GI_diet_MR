...
results_dir="/pl/active/colelab/users/kjames/refinedMR/interim_data/ldsc/PheWAS_Ttest_ldsc_results/all_gcor_files"  # Directory with results .log files
...
sed 's|/pl/active/colelab/common/published_gwas/Neale_UKB_GWAS_round2/Both_sexes/LDSC/||g' $output_file/gcor_PheWASttest_results_all.txt > $output_file/temp_results.txt
