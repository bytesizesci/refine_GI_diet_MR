# MR Analysis: PheWAS-Ttest - Sensitivity
# Author: KJS
# Date: 12/03/24 


# Exposure: oily fish intake (from clustering)
...
length(unique(pwas2$trait)) #714 unique traits
#~~~~~~~~~~~~~~~~~~~~~
...
# Check
#identical(colnames(tstat_df), trait_info_maxN$file_name) # FALSE - we delt with this above
...
# Save output objects
interim_obj_path <- "/pl/active/colelab/users/kjames/refinedMR/interim_data/PheWAS_Ttest_Sensitivity/"
save(list=c("exp_b", "exp_n", "exp_pval", "exp_se", "exp_stdB", "exp_stdSE", 
     ...
     file = paste0(interim_obj_path,"/PheWASCluster_objects_",exposure,"_", outcome,"_Sensitivity.Rdata"))

# Load if needed
load(file = paste0(interim_obj_path,"/PheWASCluster_objects_",exposure,"_", outcome,"_Sensitivity.Rdata"))
#~~~~~~~~~~~~~~~~~~~~~
# 9. Perform MR
#~~~~~~~~~~~~~~~~~~~~~
# Get variant column
...
# Save tables
# Path
phewas_table_dir <- "/pl/active/colelab/users/kjames/refinedMR/results/PheWAS_Ttest_Sensitivity/tables"
# All MR results
write.csv(MRres_df, paste0(phewas_table_dir, "/MR_PheWASCluster_Filtered_Results_", exposure,"_", outcome, "_Sensitivity.csv"))
...
# Save table
write.csv(mr_ivw_df, paste0(phewas_table_dir, "/MR_PheWASCluster_Filtered_IVWres_", exposure,"_", outcome, "_Sensitivity.csv"))
...
plots_dir <- "/pl/active/colelab/users/kjames/refinedMR/results/PheWAS_Ttest_Sensitivity/plots"

# Save
ggsave(paste0(plots_dir,"/PheWAS_Cluster_MR_",exposure, "_", outcome,"_scatterplot_allmethods_Sensitivity.png"),
       plot = MRres_p,
       device = NULL,
       path = NULL,
       scale = 1,
...
ggsave(paste0(plots_dir,"/PheWAS_Cluster_MR_",exposure, "_", outcome,"_scatterplot_IVW_weightedmdn_Sensitivity.png"),
...
phewas_table_dir <- "/pl/active/colelab/users/kjames/refinedMR/results/PheWAS_Ttest_Sensitivity/tables"
# MR results
write.csv(sig_ind_readable, paste0(phewas_table_dir, "/MR_PheWASCluster_SusSNPs_RelatedTraits_", exposure,"_", outcome, "_Sensitivity.csv"))
