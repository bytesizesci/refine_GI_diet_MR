...
#SBATCH --job-name=LDprune_whiteXwholegrain_GCST90132314_CVD_Aragam
...
apptainer exec --bind /projects/$USER,/scratch/alpine/$USER --overlay /projects/$USER/.rstudioserver/rstudio-server-4.2.2_overlay.img:ro /curc/sw/containers/open_ondemand/rstudio-server-4.2.2.sif Rscript scripts/MRCAUSE_pruneWorkFlow_clumped_whiteXwholegrain_GCST90132314_CVD_Aragam.R
