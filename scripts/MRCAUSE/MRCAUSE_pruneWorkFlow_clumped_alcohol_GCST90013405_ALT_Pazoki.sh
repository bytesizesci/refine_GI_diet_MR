...
#SBATCH --job-name=LDprune_alcohol_ALT
...
apptainer exec --bind /projects/$USER,/scratch/alpine/$USER --overlay /projects/$USER/.rstudioserver/rstudio-server-4.2.2_overlay.img:ro /curc/sw/containers/open_ondemand/rstudio-server-4.2.2.sif Rscript scripts/MRCAUSE_pruneWorkFlow_clumped_alcohol_GCST90013405_ALT_Pazoki.R
