# Updated: 11/19/24 - changed to get height PheWAS data
...
exposure <- "PheWAS_SNPs_Height_Proxies"

#Load SNPs that you want to query (gv=genetic variants)
gv <- read.csv("/pl/active/colelab/users/kjames/refinedMR/interim_data/merged_GI/PheWAS_variants_height_outcome_proxies.csv", row.names = 1)
head(gv)
