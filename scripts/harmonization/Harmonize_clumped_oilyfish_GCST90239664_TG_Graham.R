...
# Version: 2 - Update: Swap exposure SNP with proxy when needed
...
# Save
saveRDS(gi3, "interim_data/merged_GI/mrdat_exp_out_proxies_oilyfish_GCST90239664_TG_Graham_GRCh37.rds")
write.csv(gi3, "interim_data/merged_GI/mrdat_exp_out_proxies_oilyfish_GCST90239664_TG_Graham_GRCh37.csv")
