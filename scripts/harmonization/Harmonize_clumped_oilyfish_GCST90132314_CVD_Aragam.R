...
saveRDS(gi_harmon,
  #gi3,
  "interim_data/merged_GI/mrdat_exp_out_proxies_oilyfish_GCST90132314_CVD_Aragam_GRCh37.rds")
write.csv(gi_harmon,
  #gi3, 
  "interim_data/merged_GI/mrdat_exp_out_proxies_oilyfish_GCST90132314_CVD_Aragam_GRCh37.csv")
