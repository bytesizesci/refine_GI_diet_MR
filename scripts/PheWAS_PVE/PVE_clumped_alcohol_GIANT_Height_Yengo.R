...
# Remove traits with  (alcohol traits - look at md)
alcoholtraits = c("100580", "100022", "20414", "20403",
                  "1618", "5364", "1608", "1598", "1588",
                  "1578", "1568", "1558", "100670", "100710")
pwas2 <- pwas2 %>%
  filter(!(trait %in% alcoholtraits))
...
key_term <- "Alcohol consumed" #"Bread consumed" #"Oily fish intake", note- alcohol consumed isn't the direct metric but should be a good proxy
