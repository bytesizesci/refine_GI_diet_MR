...
exposure <- "oilyfish"
outcome <- "GIANT_Height_Yengo"
outcome_short <- "height"
...
# Use height PheWAS
pwas <- read.csv("interim_data/PheWAS_Grep_SNPs/PheWAS_Height_Outcome.csv")
...
# Save
#saveRDS(mrobj, paste0("interim_data/merged_GI/standardized_shared/std_mrobject_steiger_PheWASClust_PVE_240930b.rds"))
