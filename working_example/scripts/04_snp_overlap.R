...
# To do this, 
# - Get list of traits that were assigned to each cluster
...
# - Boom! Those are the traits for each cluster to move to the MVMR.
...
sus <- read.csv("~/working_example/data/MR_PheWASCluster_SusSNPs_RelatedTraits_FilePaths_alcohol_GCST90013405_ALT_Pazoki.csv")

# Load key with trait descriptions
...
write.csv(top_traits4, paste0(table_dir, "/", EXP_pheno, "_", OUT_pheno, "_hclust_snpoverlap_maxh2obs_", k,"clusters.csv"))
